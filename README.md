...
Патчи (x.x.1) — выходят примерно раз в 3 дня
Минорные обновления (x.1.x) — выходят раз в неделю
Мажорные обновления (4.x.x) — выходят раз в две недели
Примечание: график выхода обновлений стабилен, но может меняться в зависимости от обстоятельств.
